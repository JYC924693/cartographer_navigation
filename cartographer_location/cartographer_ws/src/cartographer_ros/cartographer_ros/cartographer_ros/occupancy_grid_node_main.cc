...
//LX ADD 0412
DEFINE_int32(pure_localization,0,"Pure localization !");  //修改
//END 0412
...
class Node {
 public:
  ...
  explicit Node(int pure_localization, double resolution, double publish_period_sec);//修改
  //END 0412
...
void Node::DrawAndPublish(const ::ros::WallTimerEvent& unused_timer_event) {
  ...
  if(pure_localization_ == 1) return; //修改
